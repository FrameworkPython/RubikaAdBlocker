...
```
بعد از نصب شدن کتابخانه ها، شما باید guid گپ هایی که میخواید ربات داخلش فعال بشه رو در لاین ۱۵۶ به جای guid1,guid2 وارد کنید.guid مالک هم بعدش وارد کنید.
